        ...
        ZStack {
            ...
            VStack {
                Rectangle()
                    .fill(Color("Color4"))
                    .ignoresSafeArea()
                .frame(width: 400, height: 330, alignment:  .leading)
                .overlay(
                    Rectangle()
                    .fill(Color("Color3"))
                    .ignoresSafeArea()
                .frame(width: 300, height: 330, alignment:  .trailing)
                         , alignment: .leading)
                .overlay(
                    Rectangle()
                    .fill(Color("Color2"))
                    .ignoresSafeArea()
                .frame(width: 160, height: 330, alignment:  .trailing)
                         , alignment: .leading)
                .overlay(
                    Rectangle()
                    .fill(Color("Color1"))
                    .ignoresSafeArea()
                .frame(width: 300, height: 290, alignment:  .trailing)
