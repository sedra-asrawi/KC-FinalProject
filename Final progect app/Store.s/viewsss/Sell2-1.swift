                    ...
                    HStack{
                        ...
                        HStack{
                            ...
                            NavigationLink {
                                ...
                                Buy2(products: ProdictsArray, productBuyDetails: DetailsModel(prodName: "", prodDet: "", prodPrice: "", prodImage: UIImage(), plus: "", line: ""), basketarray: basketArray, shopDet: shopDet)
...
//                    }
                    ...
                    NavigationLink {
                        ...
                        MainView(username: $username, foodstoreArray: foodstoresArray,
                                 shopDet: $shopDet,
                                giftsstoresArray: giftsstoresArray,
                                clothesstoresArray: clothesstoresArray,
                                technostoresArray: technostoresArray,
                                 otherstoresArray: otherstoresArray, productsArray: $ProdictsArray, basketArray: basketArray, ProductsDetails: ProductDet, UserPhoto: .constant(UIImage(named: "profilepic")!))
                        
//                        Home(username: .constant(""), shopsDet: .constant(shopModel(shopName: "", shopLogo: UIImage(), shoptype: "")), productsArray: .constant([]), basketArray: .constant([]))
                        
//                        Homey(username2: username,
