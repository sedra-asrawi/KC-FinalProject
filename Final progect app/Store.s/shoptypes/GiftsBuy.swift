...
struct GiftsBuy: View {
    
    let colors = [Color.white,Color("Color3")]
    @State var giftsshopsArray : [shopModel] = []
...
//                NavigationView{
    ...
    //                                        .foregroundColor(Color("Color4"))
                                    ...
                                    ScrollView(.horizontal){
                                        ...
                                        HStack {
                                            ForEach(giftsshopsArray, id: \.self){
                                                shop in
...
struct GiftsBuy_Previews: PreviewProvider {
    static var previews: some View {
        GiftsBuy(shopsName: .constant("Ananas"), shopDet: .constant(shopModel(shopName: "Ananas", shopLogo: UIImage(named: "Ananas")!, shoptype: "")), productsArray: .constant([DetailsModel(prodName: "", prodDet: "", prodPrice: "", prodImage: UIImage(), plus: "", line: "")]), basketArray: [DetailsModel(prodName: "", prodDet: "", prodPrice: "", prodImage: UIImage(), plus: "", line: "")]
        )
    }
}
