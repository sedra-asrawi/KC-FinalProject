...
struct TechnologyBuy: View {
    
    let colors = [Color.white,Color("Color3")]
    @State var technoshopsArray : [shopModel] = []
...
//                NavigationView{
    ...
    //                                        .foregroundColor(Color("Color4"))
                                    ...
                                    ScrollView(.horizontal){
                                        ...
                                        HStack {
                                            ForEach(technoshopsArray, id: \.self){
                                                shop in
                                                
                                                NavigationLink {
                                                    
                                                    Buy2(products: productsArray, productBuyDetails: DetailsModel(prodName: "", prodDet: "", prodPrice: "", prodImage: UIImage(), plus: "", line: ""), basketarray: basketArray, shopDet: shopDet)
...
struct TechnologyBuy_Previews: PreviewProvider {
    static var previews: some View {
        TechnologyBuy(shopsName: .constant("Ananas"), shopDet: .constant(shopModel(shopName: "Ananas", shopLogo: UIImage(named: "Ananas")!, shoptype: "")), productsArray: .constant([DetailsModel(prodName: "", prodDet: "", prodPrice: "", prodImage: UIImage(), plus: "", line: "")]), basketArray: [DetailsModel(prodName: "", prodDet: "", prodPrice: "", prodImage: UIImage(), plus: "", line: "")]
        )
    }
}
