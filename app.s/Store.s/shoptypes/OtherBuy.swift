...
struct OtherBuy: View {
    
    let colors = [Color.white,Color("Color3")]
    @State var othershopsArray : [shopModel] = []
...
//                NavigationView{
    ...
    //                                        .foregroundColor(Color("Color4"))
                                    ...
                                    ScrollView(.horizontal){
                                        ...
                                        HStack {
                                            ForEach(othershopsArray, id: \.self){
                                                shop in
...
struct OtherBuy_Previews: PreviewProvider {
    static var previews: some View {
        OtherBuy(shopsName: .constant("Ananas"), shopDet: .constant(shopModel(shopName: "Ananas", shopLogo: UIImage(named: "Ananas")!, shoptype: "")), productsArray: .constant([DetailsModel(prodName: "", prodDet: "", prodPrice: "", prodImage: UIImage(), plus: "", line: "")]), basketArray: [DetailsModel(prodName: "", prodDet: "", prodPrice: "", prodImage: UIImage(), plus: "", line: "")]
        )
    }
}
