...
struct Buy3_Previews: PreviewProvider {
    static var previews: some View {
        Buy3(ProdictsDetails: DetailsModel(prodName: "name", prodDet: "details", prodPrice: "10", prodImage: UIImage(named: "Ananas")!, plus: "", line: ""),ProdictsDetailsArray: .constant([DetailsModel(prodName: "", prodDet: "", prodPrice: "", prodImage: UIImage(), plus: "", line: "")])
        )
    }
}
