...
public enum Asset {
  ...
  public enum Food {
    public static let app1 = ImageAsset(name: "app1")
    public static let app2 = ImageAsset(name: "app2")
    public static let app3 = ImageAsset(name: "app3")
    public static let app4 = ImageAsset(name: "app4")
    public static let app5 = ImageAsset(name: "app5")
