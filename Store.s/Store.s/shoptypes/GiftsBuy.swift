...
struct GiftsBuy: View {
    ...
    @Binding var giftsshopsArray : [shopModel]
...
struct GiftsBuy_Previews: PreviewProvider {
    static var previews: some View {
        GiftsBuy(giftsshopsArray: .constant([shopModel(shopName: "", shopLogo: UIImage(), shoptype: "")]), shopsName: .constant("Ananas"), shopDet: .constant(shopModel(shopName: "Ananas", shopLogo: UIImage(named: "Ananas")!, shoptype: ""))
        )
    }
}
