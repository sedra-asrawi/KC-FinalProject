...
struct ClothesBuy_Previews: PreviewProvider {
    static var previews: some View {
        ClothesBuy(shopsName: .constant("Ananas"), shopDet: .constant(shopModel(shopName: "Ananas", shopLogo: UIImage(named: "Ananas")!, shoptype: "")), productsArray: .constant([DetailsModel(prodName: "", prodDet: "", prodPrice: "", prodImage: UIImage())]), basketArray: [DetailsModel(prodName: "", prodDet: "", prodPrice: "", prodImage: UIImage())]
        )
    }
}
