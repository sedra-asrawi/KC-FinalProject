...
struct ClothesBuy: View {
    ...
    @Binding var clothesshopsArray : [shopModel]
...
struct ClothesBuy_Previews: PreviewProvider {
    static var previews: some View {
        ClothesBuy(clothesshopsArray: .constant([shopModel(shopName: "", shopLogo: UIImage(), shoptype: "")]), shopsName: .constant("Ananas"), shopDet: .constant(shopModel(shopName: "Ananas", shopLogo: UIImage(named: "Ananas")!, shoptype: ""))
        )
    }
}
