...
struct OtherBuy: View {
    ...
    @Binding var othershopsArray : [shopModel]
...
struct OtherBuy_Previews: PreviewProvider {
    static var previews: some View {
        OtherBuy(othershopsArray: .constant([shopModel(shopName: "", shopLogo: UIImage(), shoptype: "")]), shopsName: .constant("Ananas"), shopDet: .constant(shopModel(shopName: "Ananas", shopLogo: UIImage(named: "Ananas")!, shoptype: ""))
        )
    }
}
