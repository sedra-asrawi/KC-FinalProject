...
struct TechnologyBuy: View {
    ...
    @Binding var technoshopsArray : [shopModel]
...
struct TechnologyBuy_Previews: PreviewProvider {
    static var previews: some View {
        TechnologyBuy(technoshopsArray: .constant([shopModel(shopName: "", shopLogo: UIImage(), shoptype: "")]), shopsName: .constant("Ananas"), shopDet: .constant(shopModel(shopName: "Ananas", shopLogo: UIImage(named: "Ananas")!, shoptype: ""))
        )
    }
}
