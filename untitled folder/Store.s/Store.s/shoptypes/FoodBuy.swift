...
struct FoodBuy_Previews: PreviewProvider {
    static var previews: some View {
        FoodBuy(shopsName: .constant("Ananas"), shopDet: .constant(shopModel(shopName: "Ananas", shopLogo: UIImage(named: "Ananas")!, shoptype: "")), productsArray: .constant([DetailsModel(prodName: "", prodDet: "", prodPrice: "", prodImage: UIImage())]), basketArray: .constant([DetailsModel(prodName: "", prodDet: "", prodPrice: "", prodImage: UIImage())])
        )
    }
}
